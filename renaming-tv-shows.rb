...
def pick_data(filepath)
  ...
  # Las Luminarias - Temporada 1 [HDTV 720p][Cap.101][AC3 5.1 Castellano][www.PCTRELOAD.COM].mkv
end
...
path = ARGV[0] || "/media/david/43e0bde7-0965-410a-a822-177427e4b5dc/descargas2"
dry = false
